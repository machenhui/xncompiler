...
var fs = require("fs");
var fileName = "./test/data/testAST-drop.js";
//fileName = "./test/data/js/min.all.js";
//fileName = "./test/data/media.js";
var defineVarName = "./test/data/defineVar.js";
var DropProperty = require("../src/js/dropUnUsedProperty");
var vm = require("vm");
...
var dropProperty = new DropProperty({
    top_level_ast:topLevelAST,
    globalVarNames:['goog']
})
...
var beforeLen = JSON.stringify(dropProperty.nodeNameCountMap).length;
console.log(JSON.stringify(dropProperty.nodeNameTree));
console.log(JSON.stringify(dropProperty.nodeNameCountMap));
dropProperty.removeUnUsed(dropProperty.nodeNameTree,dropProperty.nodeNameCountMap);
console.log("------------------------------");
console.log("------------------------------");
console.log("------------------------------");
console.log("------------------------------");
...
var afterLen = JSON.stringify(dropProperty.nodeNameCountMap).length;
console.log(beforeLen-afterLen);
//return;
