...
// This file was automatically generated from test.js.js.soy.
...
tpl.bottomBar.bar2 = function(opt_data, opt_ignored) {
  return '<div class="wa-ticket-a wa-ticket-b"><a class="wa-ticket-g" data-action="ecomBottomBar-iconBtn" onclick="javascript:void(0);" 1><i class="wa-ticket-f"></i></a><ul class="'+xnGetCssName('$$_cssFunctionStart_$$$$_cssFunctionStart_$$showCount-' + soy.$$escapeHtml(opt_data.data.length) + ' icon-container ' + ((opt_data.data.length) ? 'ddddd' : '') + '')+'$$_cssFunctionEnd_$$$$_cssFunctionEnd_$$">' + tpl.bottomBar.ulBtns(opt_data) + '<li class="wa-ticket-o" data-action="ecomBottomBar-showMore"><a onclick="javascript:void(0);">更多</a></li></ul></div>';
};
